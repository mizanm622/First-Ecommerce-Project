          ...
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              <span class="app-brand-logo demo">
               <a href="#"  rel="noopener noreferrer"><img src="{{asset('/dashboard/img/favicon/ecom.png')}}"  class="img-responsive" alt="Logo" style="width:50px"></a>
              </span>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Categoty</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="{{route('allcategory')}}" class="menu-link">
                    <div data-i18n="Connections">All category</div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                  <i class="menu-icon tf-icons bx bx-dock-top"></i>
                  <div data-i18n="Account Settings">Sub Categoty</div>
                </a>
                <ul class="menu-sub">
                  <li class="menu-item">
                  ...
                  <li class="menu-item">
                    <a href="{{route('admindashboard')}}" class="menu-link">
                      <div data-i18n="Notifications">View Sub Category</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{route('allsubcategory')}}" class="menu-link">
                      <div data-i18n="Connections">All Sub Sategory</div>
                    </a>
                  </li>
                </ul>
              </li>
                ...
                <li class="menu-item">
                  ...
                  <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                      <a href="{{route('admindashboard')}}" class="menu-link">
                        <div data-i18n="Notifications">View Product</div>
                      </a>
                    </li>
                    <li class="menu-item">
                      <a href="{{route('allproduct')}}" class="menu-link">
                        <div data-i18n="Connections">All Product</div>
                      </a>
                    </li>
                  </ul>
                </li>
                  ...
                  <ul class="menu-sub">
                    <li class="menu-item">
                      <a href="{{route('pendingorder')}}" class="menu-link">
                        <div data-i18n="Account">Pending Order</div>
                      </a>
                    </li>
                    <li class="menu-item">
                      <a href="{{route('admindashboard')}}" class="menu-link">
                    ...
                    <li class="menu-item">
                      <a href="{{route('admindashboard')}}" class="menu-link">
                        <div data-i18n="Connections">Cancel Order</div>
                      </a>
                    </li>
                  </ul>
                </li>
