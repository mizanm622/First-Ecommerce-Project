...
<html lang="en">
   ...
   <body>
            ...
            <div class="container">
               <div class="containt_main">
                  <div id="mySidenav" class="sidenav">
                     ...
                     <a href="{{route('category',[$category->id,$category->slug])}}">{{$category->categoryName}}</a>
                     @endforeach
                  ...
                  <div class="dropdown">
                     ...
                     <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        @foreach ($categories as $category)
                        <a class="dropdown-item" href="{{route('category',[$category->id,$category->slug])}}">{{$category->categoryName}}</a>
      ...
      <div class="copyright_section">
         <div class="container">
            <p class="copyright_text">© 2020 All Rights Reserved. Design by <a href="{{asset('home/https://html.design')}}">Free html  Templates</a></p>
         </div>
      </div>
